...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white shadow-md" data-aos="fade-down">
      <div className="max-w-6xl text-lg mx-auto font-medium flex justify-between items-center py-1 relative">
        ...
        <li>
            <Link href="/">
              <span className="transition-transform duration-300 ease-in-out transform hover:scale-150 inline-block">
                Home
              </span>
            </Link>
          </li>
